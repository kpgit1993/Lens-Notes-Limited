(function() {
	...
	function h(w) {
		...
		if(w && w.netseer_scriptendpoint){
			return "http://"+w.netseer_scriptendpoint;
		}

		return w && w.location && w.location.protocol
				&& "https:" == w.location.protocol.toString().toLowerCase() ? "https://ps.ns-cdn.com"
				: "http://ps.ns-cdn.com";
	}
